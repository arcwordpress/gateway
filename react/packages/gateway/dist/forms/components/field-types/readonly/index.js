...
var ReadOnlyControl = _ref => {
  ...
  var fieldValue = currentValue || configValue || defaultValue;
...
var ReadOnlyFieldTypeInput = _ref2 => {
  var _ref2$config = _ref2.config,
    config = _ref2$config === void 0 ? {} : _ref2$config;
  return /*#__PURE__*/_jsx(Field, {
    config: config,
    fieldControl: /*#__PURE__*/_jsx(ReadOnlyControl, {
      config: config
    })
  });
};
var ReadOnlyFieldTypeDisplay = _ref3 => {
  var value = _ref3.value,
    config = _ref3.config;
  if (value === null || value === undefined || value === '') {
    return /*#__PURE__*/_jsx("span", {
      className: "readonly-field__display readonly-field__display--empty",
      children: "-"
    });
  }
  return /*#__PURE__*/_jsx("span", {
    className: "readonly-field__display",
    children: String(value)
  });
};
export var readonlyFieldType = {
  type: 'readonly',
  Input: ReadOnlyFieldTypeInput,
  Display: ReadOnlyFieldTypeDisplay,
  defaultConfig: {}
};
export var useReadOnlyField = config => {
  return useMemo(() => ({
    Input: props => /*#__PURE__*/_jsx(ReadOnlyFieldTypeInput, _objectSpread(_objectSpread({}, props), {}, {
      config: config
    })),
    Display: props => /*#__PURE__*/_jsx(ReadOnlyFieldTypeDisplay, _objectSpread(_objectSpread({}, props), {}, {
      config: config
    }))
  }), [config]);
};