  ...
  return (
    <ExtensionListProvider>
      <ActiveExtensionProvider>
        <HashRouter>
          <div className="app-bg app-main-margin-fix min-h-screen flex" style={{borderLeft: 'solid 1px var(--color-border)'}}>
            <LeftSidebar />
            <div className="flex-1 flex flex-col">
              <header className="px-8 py-4 flex items-center justify-between" style={{borderBottom: 'solid 1px var(--color-border)'}}>
                <Breadcrumbs />
