...
/* harmony import */ var _components_DataTable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/DataTable */ "./src/components/DataTable.js");
/* harmony import */ var _services_collectionService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/collectionService */ "./src/services/collectionService.js");
...
const App = ({
  ...
  }, collection?.name || collectionKey), collection?.table && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "text-sm text-gray-500 mt-1"
  }, "Table: ", collection.table)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_DataTable__WEBPACK_IMPORTED_MODULE_2__["default"], {
    data: data,
    columns: columns,
    loading: loading
  }));
 ...
 */
const createRecord = async (namespace, route, data) => {
  try {
    const url = `${namespace}/${route}`;
 ...
 */
const updateRecord = async (namespace, route, id, data) => {
  try {
    const url = `${namespace}/${route}/${id}`;
...
gridElements.forEach(element => {
  ...
  if (collectionKey) {
    ...
    root.render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_App__WEBPACK_IMPORTED_MODULE_2__["default"], {
