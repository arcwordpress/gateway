...
/**
 * Global forms graph — collections data passed in from FormsTopLevel
 * (already fetched via the single ?with_nested=true bulk request).
 */
export function GlobalFormsGraph({ collections }: { collections: Collection[] }) {
  ...
  collections.forEach((collection) => {
    ...
    forms.forEach((form: { form_key: string; title?: string }, idx: number) => {
