...
/***/ "./blocks/gt1/src/TemplateBlock.js":
/*!*****************************************!*\
  !*** ./blocks/gt1/src/TemplateBlock.js ***!
  \*****************************************/
...
/* harmony export */   "default": () => (/* binding */ TemplateBlock)
/* harmony export */ });
...
function TemplateBlock({
  ...
  const [template, setTemplate] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
...
function parseTemplate(templateString) {
  ...
  let cleaned = templateString.replace(/<\?php[\s\S]*?\?>/gi, '') // Remove PHP tags
  .trim();

  // Check if there's an InnerBlocks placeholder
  if (!/<InnerBlocks\s*\/?>/i.test(cleaned)) {
    // No InnerBlocks found, just parse as HTML
    return (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(cleaned);
  }
  ...
  return (0,html_react_parser__WEBPACK_IMPORTED_MODULE_3__["default"])(cleaned, {
    replace: domNode => {
      ...
      if (domNode.type === 'tag' && domNode.name.toLowerCase() === 'innerblocks') {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks, {});
      }
    }
  });
}
...
/* harmony import */ var _TemplateBlock__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TemplateBlock */ "./blocks/gt1/src/TemplateBlock.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__);
...
const registerBlocks = blocks => {
  blocks.forEach(block => {
    ...
    (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(block.name, {
      title: block.title,
      category: 'layout',
      edit: props => hasInnerBlocks ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_TemplateBlock__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      save: props => hasInnerBlocks ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks.Content, {}) : null
    });
  });
};
