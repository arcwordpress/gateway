...
/**
 * Migration: add label_field column to gateway_raptor_collection
 *
 * Stores the field name used as the human-readable label for a record
 * (e.g. "name", "description") when the collection does not use the
 * conventional "title" or "label" field.
 *
 * Safe to run multiple times — dbDelta() is idempotent.
 */
class RaptorCollectionLabelFieldMigration
{
